-- ============================================================
-- NT AI Assistant - Schema Metadata
...
VALUES (
    ...
    (
        ...
        'ชื่อบัญชี GL',
        'Text',
        'ดอกเบี้ยเงินให้กู้ยืม-กองทุนสวัสดิการ',
        0,
        1
    ),
    (
    ...
    (
        ...
        'รหัส+ชื่อหมวดบัญชี',
        'Display',
        'R10 ผลตอบแทนทางการเงินและรายได้อื่น',
        0,
        1
    ),
    (
...
VALUES (
    ...
    (
        ...
        1,
        0,
        'หน่วยเป็นบาท ปกติเท่ากับ REVENUE_VALUE'
    );
-- ============================================================
...
VALUES (
        'DATE_CONVERT',
        'แปลง DATE ก่อนใช้',
        'DATE เก็บเป็น Unix Timestamp (ms) ต้องแปลงก่อนแสดงผล',
        'DATE',
    ...
    (
        'REVENUE_UNIT',
        'หน่วยรายได้เป็นบาท',
        'REVENUE_VALUE และ AMOUNT มีหน่วยเป็นบาท ไม่ใช่ล้านบาท',
...
-- ============================================================
INSERT INTO schema_sample_values (
        table_name,
        column_name,
        sample_value,
        value_description,
