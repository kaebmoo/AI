...
CREATE TABLE IF NOT EXISTS ai_providers (
    id TEXT PRIMARY KEY,
    -- e.g., 'claude', 'gemini', 'matcha', 'openai'
    name TEXT NOT NULL,
    -- Display name: 'Claude', 'Gemini'
    display_name TEXT,
    -- Full display: 'Claude (Anthropic)'
    icon TEXT DEFAULT 'bulb',
    -- Icon name for UI (Ionicons)
    ...
    api_url_env_var TEXT,
    -- For providers with custom URLs: 'MATCHA_API_URL'
    default_api_url TEXT,
    -- Default API URL if not in env
    description TEXT,
...
VALUES (
        ...
        'ANTHROPIC_API_KEY',
        20,
        'Anthropic Claude models - Best for reasoning and analysis'
    ),
    (
        'gemini',
        'Gemini',
        ...
        'GOOGLE_AI_API_KEY',
        10,
        'Google Gemini models - Fast and efficient'
    ),
    (
        'matcha',
        'Matcha',
        ...
        'MATCHA_AI_API_KEY',
        30,
        'OpenAI models via NT Gateway - Default provider'
    );
-- ============================================================
...
VALUES (
        ...
        1,
        40,
        'Latest Sonnet model - Balanced performance'
    ),
    (
        'claude',
        'claude-opus-4-6',
...
VALUES (
        ...
        1,
        40,
        'Latest Gemini model - Fast and capable'
    ),
    (
        'gemini',
...
VALUES (
        ...
        1,
        40,
        'Latest GPT-4 model via NT Gateway'
    ),
    (
        'matcha',
        'gpt-4o',
...
VALUES (
        'matcha_api_url',
        'https://aigateway.ntictsolution.com/v1/chat/completions',
        'api_key',
        'ai',
        'Matcha API URL',
        'NT Gateway API endpoint for Matcha (OpenAI compatible)'
    );
-- ============================================================
...
-- ============================================================
CREATE TRIGGER IF NOT EXISTS enforce_single_default_provider BEFORE
UPDATE ON ai_providers
    WHEN NEW.is_default = 1
    AND OLD.is_default = 0 BEGIN
UPDATE ai_providers
SET is_default = 0
WHERE is_default = 1
    AND id != NEW.id;
...
-- ============================================================
CREATE TRIGGER IF NOT EXISTS enforce_single_default_model_per_provider BEFORE
UPDATE ON ai_models
    WHEN NEW.is_default = 1
    AND OLD.is_default = 0 BEGIN
UPDATE ai_models
