...
| [PORTAL_GOLIVE.md](changelogs/PORTAL_GOLIVE.md) | เปิดใช้จริง: NT-Report portal (2026-09-20) — ฝั่ง AI เปิดแล้ว (migrate, key จริงผูก workspace, allowlist matcha, retention รอบแรก), prompt บอกขอบเขตของ `scope` + งวดอ้างอิง; ตอนเขียนปุ่มยังไม่เปิด — **ต่อมาเปิดเฉพาะ `revenue`** (2026-09-20 ดึก; `RESULT_F11.md` §7–§8) |
