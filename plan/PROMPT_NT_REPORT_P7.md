...
|---|---|
| **ฐานเปรียบเทียบไม่ได้ประกาศไว้** (REV8, REV10) | contract ไม่มีกฎว่า "เทียบปีก่อนใช้ฐานไหน" (ex-divested 27,068.13 ไม่ใช่ raw 45,603) และ "เป้ารายเดือนมีเฉพาะ BG 1–7" → ทั้งสองอย่างอยู่ใน `assistant_reference` แต่ไม่อยู่ใน contract ที่โมเดลเห็น — **เสนอเพิ่มเป็น business_rule (PATCH)** |
