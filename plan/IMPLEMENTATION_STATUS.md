...
- **Eval harness (F3-B)** — `scripts/eval/run_eval.py` execution-match accuracy จาก golden examples, `--compare` แสดง regression; feed_revenue baseline 92.9% (`plan/RESULT_F10.md`)
